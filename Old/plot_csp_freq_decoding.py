...
#        
#        chance = 0.5  # set chance level to white in the plot
#        av_tfr.plot([0], vmin=chance, title="Time-Frequency Decoding Scores %s" %a_vs_b,
#                    cmap=plt.cm.Reds)
#    
#    plt.savefig(ana_path + 'csp_time_freq_decoding_%s_%s.pdf' %(a_vs_b, subject), bbox_to_inches='tight')
#    
    ###############################################################################
    ...
    plt.savefig(ana_path + 'csp_freq_decoding_%s_%s.pdf' %(a_vs_b, subject), bbox_to_inches='tight')
